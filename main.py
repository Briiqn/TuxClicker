...
class TuxClicker(Thread):
    ...
    def run(self):
        while True:
            ...
            sleep(random.choice([random.triangular(delay, delay) * slider.get() / slider1.get() * random.uniform(.99999999999999999, 1.40099999999999999999999) * truerand.uniform(2, 2.5099999999999999) * wtfrand * random.triangular(.5555555555555, 2.5555555555555) / truerand.uniform(wtfrand, 2.099999999999999999) * random.uniform(wtfrand, wtfrand) / random.uniform(random.uniform(wtfrand, wtfrand), truerand.uniform(wtfrand, wtfrand)) / random.uniform(truerand.uniform(.999999999999999999999999999, 1.1), random.uniform(1.299999999999999999999, 1.3)) * timerandom / random.uniform(1.068, 1.07), normdelay * slider.get() / slider1.get() * .99 * 1.4 * 2.5 * 2.1 * 1.6 / 2.09 * 2.1 * 1.1 * 1.3 * 1.08 / 1.07 / random.randint(5, 7),
            random.triangular(delay, delay) * slider.get() / slider1.get() * random.uniform(.99999999999999999, 1.40099999999999999999999) * truerand.uniform(2, 2.5099999999999999) * wtfrand * random.triangular(.5555555555555, 2.5555555555555) / truerand.uniform(wtfrand, 2.099999999999999999) * random.uniform(wtfrand, wtfrand) / random.uniform(random.uniform(wtfrand, wtfrand), truerand.uniform(wtfrand, wtfrand)) / random.uniform(truerand.uniform(.999999999999999999999999999, 1.1), random.uniform(1.299999999999999999999, 1.3)) * timerandom / random.uniform(1.068, 1.07), normdelay * slider.get() / slider1.get() * .99 * 1.4 * 2.5 * 2.1 * 1.6 / 2.09 * 2.1 * 1.1 * 1.3 * 1.08 / 1.07 / random.randint(5, 6), normdelay * slider.get() / slider1.get() * .99 * 1.4 * 2.5 * 2.1 * 1.6 / 2.09 * 2.1 * 1.1 * 1.3 * 1.08 / 1.07 / random.randint(6, 7), random.triangular(delay, delay) * slider.get() / slider1.get() * random.uniform(.99999999999999999, 1.40099999999999999999999) * truerand.uniform(2, 2.5099999999999999) * wtfrand * random.triangular(.5555555555555, 2.5555555555555) / truerand.uniform(wtfrand, 2.099999999999999999) * random.uniform(wtfrand, wtfrand) / random.uniform(random.uniform(wtfrand, wtfrand), truerand.uniform(wtfrand, wtfrand)) / random.uniform(truerand.uniform(.999999999999999999999999999, 1.1), random.uniform(1.299999999999999999999, 1.3)) * timerandom / random.uniform(1.068, 1.07)]))
